                    ...
                    <tbody>
                        @foreach($students as $student)
                            <tr>
                                ...
                                <td>{{ $student->exchanges_id }}</td>
                                <td>{{ $student->internship_id }}</td>
                                <td>
                                    @if($student->photo)
                                        <img src="{{ asset('storage/students/'.$student->photo) }}" alt="Teacher Photo" class="img-student rounded-circle" width="50" >
                                    @else
                                        No Photo
                                    @endif
                                </td>
