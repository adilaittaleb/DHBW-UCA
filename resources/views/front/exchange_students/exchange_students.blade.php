       ...
       <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            ...
            <div class="row g-5">
                ...
                <p class="mb-4 p-size" >Host institution means the institution which has agreed to accept the student from the home institution.</p>
                    
                </div>
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s" src="img/students_exchange.jpeg" style="object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            ...
            <div class="row g-5">
                ...
                <p class="mb-4 p-size" >To come to the host institution as an exchange student, your home university must have a formal agreement for exchange studies with it .All exchange students must be registered and must remain enrolled as fulltime degree-seeking at the home institution as a condition of acceptance into the exchange program. Exchange students must be in good academic standing prior to participating in the exchange program. Students are eligible to participate if they have satisfied any language proficiency requirements of the host institution.</p>
                    
                </div>
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s" src="img/exchange_students.jpg" style="object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
